...
namespace LibSM64
{
    public class SM64Mario : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            if (material == null) {
                material = CVRSuperMario64.CVRSuperMario64.GetMarioMaterial();
            }
        ...
        public void contextUpdate() {
            ...
            if (inputProvider.IsMine()) {
                transform.position = Vector3.LerpUnclamped( states[buffIndex].unityPosition, states[j].unityPosition, t );
            }
            else {
                // Calculate the difference between the mario and the spawnable position. To offset the de-synchronization
                var gamePos = Vector3.LerpUnclamped( states[buffIndex].unityPosition, states[j].unityPosition, t );
                marioRendererObject.transform.position = transform.position - gamePos;
            }
