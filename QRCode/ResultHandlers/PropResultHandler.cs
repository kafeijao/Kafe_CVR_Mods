...
public class PropResultHandler : ResultHandler {

    private const string Name = "CVR Prop";
    ...
    protected override bool HandleResult(string text, out Result result) {
        ...
        result = new Result(Name, ModConfig.ImageSprites[ModConfig.ImageType.Prop], text, () => ViewManager.Instance.GetPropDetails(guid.ToString("D")));
        return true;
    }
}
