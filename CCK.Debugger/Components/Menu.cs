...
public class Menu : MonoBehaviour {
    ...
    private static Action<Menu> lastUpdateHandler = AvatarMenuHandler.Update;
    ...
    void Start() {
        ...
        void SwitchMenu() {
            Action<Menu> newHandlerUpdate = lastUpdateHandler == AvatarMenuHandler.Update
                ? SpawnableMenuHandler.Update
                : AvatarMenuHandler.Update;
            Action<Menu> newHandlerInit = lastUpdateHandler == AvatarMenuHandler.Update
                ? SpawnableMenuHandler.Init
                : AvatarMenuHandler.Init;
            Events.DebuggerMenu.MenuUpdate -= lastUpdateHandler;
            newHandlerInit.Invoke(this);
            Events.DebuggerMenu.MenuUpdate += newHandlerUpdate;
            lastUpdateHandler = newHandlerUpdate;
        }

        Events.DebuggerMenu.MainNextPage += SwitchMenu;
        Events.DebuggerMenu.MainPreviousPage += SwitchMenu;
        
        Events.DebuggerMenu.OnMenuInit(this);
    }
    
    void Update() {
        Events.DebuggerMenu.OnMenuUpdate(this);
    }
