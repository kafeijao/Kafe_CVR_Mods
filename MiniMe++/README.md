...
### Features:
- Scale your own MiniMe
- View other people's MiniMe
    - Requires the other person to have the mod
    - Requires the other person anchor mode to be set to playspace or world
    - Requires MiniMe to be enabled :)
