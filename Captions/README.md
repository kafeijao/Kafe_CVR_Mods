...
**⚠️NOTE1⚠️:** This mod is heavy on performance, both GPU, GPU and Memory!
...
- Thanks [Noachi](https://github.com/NoachiCode) for suggesting revisiting this mod as there was now a faster revision
  of the model (turbo v3). Note to self: I should stop listening to your suggestions as it always ends up in pain and 
  misery, it's like a curse
